...
- In a terminal, navigate to `ReusableStateBotTemplate`

    ```bash
    # change into project folder
    cd ReusableStateBotTemplate
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `ReusableStateBotTemplate` folder
  - Select `ReusableStateBotTemplate.csproj` file
